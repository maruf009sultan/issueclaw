...
- `state/personality.md` — write your name, nature, vibe, emoji, hatch date, who hatched you
- `state/user.md` — their name, how to address them, any notes
- `state/memory.md` — append any durable facts (your identity, their preferences)
- `AGENTS.md` — optionally update the identity section
